...
contract DisputeModule is BaseContract {
     ...
     */
    function openDispute(uint256 _projectId, string memory _reason) public projectExists(_projectId) onlyClient(_projectId) {
        require(disputes[_projectId].status == DisputeStatus.None, "Dispute already exists");
     ...
     */
    function getDispute(uint256 _projectId) public view returns (address, string memory, uint256, DisputeStatus) {
